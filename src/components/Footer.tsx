        ...
        <div className="bg-white/10 dark:bg-black/20 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-white/10 shadow-lg p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <button
              ...
              className="flex items-center space-x-2 text-sm text-gray-300 dark:text-gray-700 hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors duration-200"
            >
