...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 bg-white text-slate-900 dark:text-white transition-colors duration-300">
      {/* Glass Navigation */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="backdrop-blur-xl bg-white/80 dark:bg-white/5 rounded-2xl border border-slate-200 dark:border-white/10 p-6">
              ...
              <div className="space-y-4">
                ...
                {habits.length === 0 && <div className="text-slate-500 dark:text-gray-400 text-center py-4">
